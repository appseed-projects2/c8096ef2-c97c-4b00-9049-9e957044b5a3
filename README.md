...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-08-22 16:01`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c8096ef2-c97c-4b00-9049-9e957044b5a3.git
$ cd c8096ef2-c97c-4b00-9049-9e957044b5a3
```
